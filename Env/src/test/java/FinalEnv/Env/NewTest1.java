  ...
  public Object[][] dp()
   {
	...
	@Test
	public void checkGmailTitle() //throws InterruptedException
	{
		String eGmailTitle = "Gmail";

		driver.findElement(By.linkText("Gmail")).click();
		String aGmailTitle = driver.getTitle();
		APP_LOG.debug("Gmail Site Title Captured");

		if (aGmailTitle.contains(eGmailTitle))
		{
			System.out.println("checkGmailTitle Test Passed");
			APP_LOG.debug("checkGmailTitle Test Passed");
		}
		else
		{
			System.out.println("checkGmailTitle Test Failed");
			APP_LOG.debug("checkGmailTitle Test Failed");
		}
	}
